...
public class Context {
     ...
     * see {@link ServerUtil#getSenderId(CommandSender)}
     *
     ...
     */
    public <T, S extends CommandSender> T runInContext(S sender, ContextProperties contextProperties, BiFunction<S, ContextProperties, T> function) {
